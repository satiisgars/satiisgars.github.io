...
<p style="line-height: 1.8em; font-size: 0.95em;">
  회원 여러분, 안녕하세요:)<br>
  위성지능정보학회입니다.<br>
  제2회 위성지능정보학회 워크샵을 다음과 같이 개최하고자 하오니 회원 여러분들의 많은 관심과 참여를 부탁드립니다.
</p>
...
<ul style="font-size: 0.95em; line-height: 1.8em;">
  <li><strong>일시:</strong> 2026년 5월 29일 (금) 10:00 – 14:00</li>
  <li><strong>장소:</strong> 그랜드 인터컨티넨탈 서울 파르나스 메이플(5F)</li>
  <li><strong>주제:</strong> 차세대 위성지능정보 활용 전략</li>
</ul>
...
<table style="width:100%; border-collapse: collapse; font-size: 0.9em; text-align: center;">
  ...
  <tbody>
    ...
    <tr>
      <td style="border:1px solid #ddd; padding:0.6em;">09:20–09:50 (30')</td>
      <td style="border:1px solid #ddd; padding:0.6em;">등록</td>
      <td style="border:1px solid #ddd; padding:0.6em;">-</td>
    </tr>

    <tr>
      <td style="border:1px solid #ddd; padding:0.6em;">09:50–10:00 (10')</td>
    ...
    <tr>
      <td style="border:1px solid #ddd; padding:0.6em;">10:00–11:30 (90')</td>
      <td style="border:1px solid #ddd; padding:0.6em;">
        AI반도체(NPU) 현황 및 산업별 Use Case
      </td>
      <td style="border:1px solid #ddd; padding:0.6em;">
        홍상균<br>(정보통신산업진흥원)
      </td>
    ...
    <tr>
      <td style="border:1px solid #ddd; padding:0.6em;">11:30–11:45 (15')</td>
      <td style="border:1px solid #ddd; padding:0.6em;">
    ...
    <tr>
      <td style="border:1px solid #ddd; padding:0.6em;">11:45–12:00 (15')</td>
      <td style="border:1px solid #ddd; padding:0.6em;">
        국가위성의 개발과 활용
      </td>
      <td style="border:1px solid #ddd; padding:0.6em;">
    ...
    <tr>
      <td style="border:1px solid #ddd; padding:0.6em;">12:00–12:20 (20')</td>
      <td style="border:1px solid #ddd; padding:0.6em;">
    ...
    <tr>
      <td style="border:1px solid #ddd; padding:0.6em;">12:20–12:40 (20')</td>
      <td style="border:1px solid #ddd; padding:0.6em;">
    ...
    <tr>
      <td style="border:1px solid #ddd; padding:0.6em;">13:00–14:00 (60')</td>
      <td style="border:1px solid #ddd; padding:0.6em;">
        자유토론 및 오찬
      </td>
      <td style="border:1px solid #ddd; padding:0.6em;"></td>
...
<ul style="font-size: 0.95em; line-height: 1.8em;">
  <li><strong>사전등록 마감:</strong> 2026년 5월 27일(수)까지</li>
...
<p>
<a href="https://forms.gle/YUQDNxpjhpgEXowr9" target="_blank" class="button">
☞ 사전등록
</a>
</p>
