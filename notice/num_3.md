...
<table style="width:100%; border-collapse: collapse; font-size:0.9em; text-align:center;">
  ...
  <thead>
    <tr style="background-color:#eef5f7;">
      <th style="border:1px solid #555; padding:0.6em; width:13%;">
        시간
      </th>

      <th style="border:1px solid #555; padding:0.6em;">
        발표주제 및 내용
      </th>

      <th style="border:1px solid #555; padding:0.6em; width:26%;">
        발표자
      </th>
    </tr>
  </thead>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="2"
          style="border:1px solid #555; padding:0.6em;">
